...
<script type="text/javascript">
    ...
    function to_page(pn){
        $.ajax({
            url:"${APP_PATH}/queryDoctor1",
            data:"pn="+pn,
            type:"GET",
            success:function(result){
                //console.log(result);
                //1、解析并显示员工数据
                build_Doctor_table(result);
                //2、解析并显示分页信息
